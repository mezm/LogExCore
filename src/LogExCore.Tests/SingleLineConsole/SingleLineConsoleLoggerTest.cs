...
//            msg.Text.Should().MatchRegex(@"^\d{2}:\d{2}:\d{2}");
//            msg.Text.Substring(9).Should().Be("I [SingleLineConsoleLoggerTest] test message with 12");
//        }
...
//            _sink.ReceivedWithAnyArgs().Push(default);
//            var msg = (ConsoleMessage)_sink.ReceivedCalls().First().GetArguments()[0];
//            msg.Text.Should().MatchRegex(dateTimeRx);
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => x.Text.Contains($" {levelStr} ")));
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => x.Text.Contains(" [LogExCore.Tests.SingleLineConsole.SingleLineConsoleLoggerTest] ")));
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => x.Text.Contains(" [SingleLineConsoleLoggerTest] ")));
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => x.Text.StartsWith("DEBUG")));
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => !x.Text.Contains("DEBUG")));
//        }
...
//            _sink.Received().Push(Arg.Is<ConsoleMessage>(x => x.Text.Contains("any log message")));
//        }
//    }
//}
